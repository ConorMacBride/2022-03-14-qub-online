...
venue: "Queen's University Belfast"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
address: "online"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria"), videoconferencing URL, or 'online'
country: "gb"      # lowercase two-letter ISO country code such as "fr" (see https://en.wikipedia.org/wiki/ISO_3166-1#Current_codes) for the institution that hosts the workshop
language: "en"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes) for the workshop
latitude: "37.184"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-93.373"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Mar 14-16, 2022"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "10:00 am - 3:00 pm UTC"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
helper: ["Conor MacBride", "Sinéad Mannion", "Luke Roantree", "Daniel Molloy", "David Young", "Ken Smith", "James Gillanders"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
